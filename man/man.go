...
.\"
.TH "CITOP" "1" "November 2019" "" "version 0.0"
.hy
.SH NAME
.PP
...
.SH SYNOPSIS
.PP
\f[B]\f[CB]citop\f[B]\f[R] \f[C][--commit=COMMIT]\f[R]
\f[C][--repository=REPOSITORY]\f[R]
.PP
...
.TE
.SH OPTIONS
.SS \f[C]-c, --commit=COMMIT\f[R]
.PP
Specify the commit to monitor.
COMMIT is expected to be the sha1 identifier of a commit.
...
\f[R]
.fi
.SS \f[C]-r, --repository=REPOSITORY\f[R]
.PP
