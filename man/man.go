...
.\"
.TH "CITOP" "1" "December 03, 2019" "" "version 0.0.0-78-geb588b5"
.hy
.SH NAME
.PP
...
citop 64be3c6
# Show pipelines associated to the commit referenced by the tag \[aq]0.9.0\[aq]
citop 0.9.0
# Show pipelines associated to the commit at the tip of the branch \[aq]feature/doc\[aq]
citop feature/doc
\f[R]
.fi
.SH OPTIONS
