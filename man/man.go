...
INTERACTIVE COMMANDS
   ...
   v
       View the log of the job at the cursor.  The log may be incomplete if the job is still
       running.
...
CONFIGURATION FILE
   Location
       citop follows the XDG base directory specification and expects to find the configura‐
       tion file at one of the following locations:

       1. $XDG_CONFIG_HOME/citop/citop.toml

       2. $HOME/.config/citop/citop.toml if XDG_CONFIG_HOME is not set

       3. $DIR/citop/citop.toml for every directory DIR in the comma-separated list XDG_CON‐
          FIG_DIRS
